...
![Annoyance vs. complexity](/post/2019-11-20-academic-writing-with-rmarkdown_files/xkcd_markdown_word.png){width=80%}
...
As promised above, we can also embed inline code. 
